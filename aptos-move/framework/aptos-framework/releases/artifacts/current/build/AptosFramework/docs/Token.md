...
<pre><code><b>struct</b> <a href="Token.md#0x1_Token_Collection">Collection</a>&lt;TokenType: <b>copy</b>, drop, store&gt; <b>has</b> drop, store
</code></pre>
...
<dl>
<dt>
<code>tokens: <a href="Table.md#0x1_Table_Table">Table::Table</a>&lt;<a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/GUID.md#0x1_GUID_ID">GUID::ID</a>, <a href="Token.md#0x1_Token_Token">Token::Token</a>&lt;TokenType&gt;&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>claimed_tokens: <a href="Table.md#0x1_Table_Table">Table::Table</a>&lt;<a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/GUID.md#0x1_GUID_ID">GUID::ID</a>, vector&lt;<b>address</b>&gt;&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="Token.md#0x1_Token_create_token">create_token</a>&lt;TokenType: <b>copy</b> + drop + store&gt;(
    ...
    <b>let</b> collection_token = <a href="Token.md#0x1_Token">Token</a> {
        id: <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/GUID.md#0x1_GUID_id">GUID::id</a>(&<a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/GUID.md#0x1_GUID_create">GUID::create</a>(account)),
    ...
    <b>let</b> claimed_tokens = <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_empty">Vector::empty</a>();
    <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>(&<b>mut</b> claimed_tokens, account_addr);
    <a href="Table.md#0x1_Table_insert">Table::insert</a>(&<b>mut</b> collection.claimed_tokens, *&collection_token.id, claimed_tokens);
...
<pre><code><b>public</b> <b>fun</b> <a href="Token.md#0x1_Token_withdraw_token">withdraw_token</a>&lt;TokenType: <b>copy</b> + drop + store&gt;(
    ...
    token_id: ID,
    amount: u64,
): <a href="Token.md#0x1_Token">Token</a>&lt;TokenType&gt; <b>acquires</b> <a href="Token.md#0x1_Token_Collections">Collections</a>, <a href="Token.md#0x1_Token_Gallery">Gallery</a> {
    <b>let</b> account_addr = <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(account);
    ...
    <b>let</b> collection_id = <a href="Table.md#0x1_Table_borrow">Table::borrow</a>(gallery, &token_id).collection;
    <b>let</b> creator_addr = <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/GUID.md#0x1_GUID_id_creator_address">GUID::id_creator_address</a>(&collection_id);
    ...
    <b>let</b> collection = <a href="Table.md#0x1_Table_borrow_mut">Table::borrow_mut</a>(collections, &collection_id);
    <b>let</b> claimed_tokens = <a href="Table.md#0x1_Table_borrow_mut">Table::borrow_mut</a>(&<b>mut</b> collection.claimed_tokens, &token_id);

    <b>if</b> (balance == amount) {
        <b>let</b> (found, idx) = <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_index_of">Vector::index_of</a>(claimed_tokens, &account_addr);
        <b>assert</b>!(found, <a href="Token.md#0x1_Token_EMISSING_CLAIMED_TOKEN">EMISSING_CLAIMED_TOKEN</a>);
        <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_swap_remove">Vector::swap_remove</a>(claimed_tokens, idx);
...
<pre><code><b>public</b> <b>fun</b> <a href="Token.md#0x1_Token_deposit_token">deposit_token</a>&lt;TokenType: <b>copy</b> + drop + store&gt;(
    ...
    <b>let</b> claimed_tokens = <a href="Table.md#0x1_Table_borrow_mut">Table::borrow_mut</a>(&<b>mut</b> collection.claimed_tokens, &token.id);
    <a href="../../../../../../../aptos-framework/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>(claimed_tokens, account_addr);
